        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  >
                    Three words that describe {daughterName}
                  </FieldLabel>
                  <TextArea
              ...
              <div className="space-y-6">
                ...
                <div>
                  <FieldLabel hint="A quality, habit, or way she approaches things. This is the lead-in to the next question.">
                    What is something about {daughterName} that&apos;s always
                    been true of her?
                  </FieldLabel>
                  <TextArea
          ...
          {step === 4 && (
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <FieldLabel hint={`Not a category ("he's kind") — something particular. A moment, or something you've observed more than once.`}>
                    One specific thing you&apos;ve noticed about {partnerName}
                  </FieldLabel>
                  <TextArea
              ...
              <div className="space-y-6">
                ...
                <div>
                  <FieldLabel hint="A way of approaching things, a habit, something consistent from childhood to today.">
                    Is there something {daughterName} does now that she&apos;s
                    always done?
                  </FieldLabel>
                  <TextArea
                    rows={3}
                ...
                <div>
                  <FieldLabel>
                    What has surprised you most about who {daughterName} has
                    become?
                  </FieldLabel>
                  <TextArea
                    rows={3}
                ...
                <div>
                  <FieldLabel>
                    If {daughterName} were giving this speech about you — what
                    would she say?
                  </FieldLabel>
                  <TextArea
                    rows={3}
                  ...
                  />
                  <div className="mt-2">
                    <SkipButton onSkip={() => skipField("what_shed_say")} />
                  </div>
                </div>
                ...
                <div>
                  <FieldLabel>
                    ...
                    {daughterName} that you&apos;d like to say today?
                  </FieldLabel>
                  <TextArea
                    rows={3}
                ...
                <div>
                  <FieldLabel>
                    How long have {daughterName} and {partnerName} been
                    together, and when did you know {partnerName} was serious
                    about her?
                  </FieldLabel>
                  <TextInput
                  ...
                  />
                  <div className="mt-2">
                    <SkipButton onSkip={() => skipField("partner_timeline")} />
                  </div>
                </div>
              </div>
          ...
          {step === 6 && (
            <div>
              ...
              {/* Email */}
              <div className="mb-8">
                <FieldLabel required hint="We'll send your four speech drafts here. Valid for 7 days.">
